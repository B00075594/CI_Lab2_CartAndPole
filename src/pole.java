...
public class pole extends Applet implements Runnable {
    ...
    public void FuzzyControllerSetup()
    {
    	...
    	engine = new Engine();
    	engine.setName("Lab 2 - Cart and Pole");
    	...
    	outputVariable.setDefuzzifier(new MeanOfMaximum(200));
    	outputVariable.setDefaultValue(Double.NaN);
    	outputVariable.setLockValidOutput(false);
    	outputVariable.setLockOutputRange(false);
    	outputVariable.addTerm(new Trapezoid("NH", -32.000, -32.000, -24.000, -8.000));
    	...
    	outputVariable.addTerm(new Trapezoid("PH", 8.000, 24.000, 32.000, 32.000));
